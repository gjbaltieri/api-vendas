...
var _ICustomer = require("../../../../../shared/interface/relationship/ICustomer");
...
let Order = (_dec = (0, _typeorm.Entity)('orders'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.ManyToOne)(() => _Customer.default), _dec5 = (0, _typeorm.JoinColumn)({
  name: 'customer_id'
}), _dec6 = Reflect.metadata("design:type", typeof _ICustomer.ICustomer === "undefined" ? Object : _ICustomer.ICustomer), _dec7 = (0, _typeorm.OneToMany)(() => _OrdersProducts.default, order_products => order_products.order, {
  cascade: true
}), _dec8 = Reflect.metadata("design:type", Array), _dec9 = (0, _typeorm.CreateDateColumn)({
  type: 'timestamp with time zone'
}), _dec10 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec11 = (0, _typeorm.UpdateDateColumn)({
  type: 'timestamp with time zone'
}), _dec12 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = class Order {
  constructor() {
